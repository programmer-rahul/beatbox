...
function PlayPauseMusicIcon({size = 30}: {size?: number}) {
  ...
  return isTrackPlaying ? (
    <Pause color={COLORS.main} size={size} onPress={onTrackPlayPause} strokeWidth={1.6}/>
  ) : (
    <Play color={COLORS.secondaryIcon} size={size} onPress={onTrackPlayPause} strokeWidth={1.6}/>
  );
}
